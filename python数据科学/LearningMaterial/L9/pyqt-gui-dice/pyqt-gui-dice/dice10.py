...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Let's display the maximum possible.
        self.max = QLabel("Maximum possible: 6")
        # Connect the signal from editing the text boxes to a slot to update the label.
        self.dice_number.textEdited.connect(self.dice_changed)
        self.dice_size.textEdited.connect(self.dice_changed)
